...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const cssPath = 'https://raw.githubusercontent.com/protzman/nord-slack-theme/master/nord.css';
    ...
    body {
        ...
        /* src: url('https://fonts.googleapis.com/css?family=Raleway:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i'); */
        text-rendering: optimizeLegibility important;
        font-weight: 500 !important;
        word-spacing: -1px;
    }
    div.c-message.c-message--light.c-message--hover {
        color: var(--nord09) !important;
    }
    .c-message__sender a {
        font-weight: 600;
    ...
    div.c-virtual_list__scroll_container {
        background-color: var(--nord00) !important;
    }
    ...
    .c-scrollbar__hider {
        background: #var(--nord00) !important;
    }
    #team_menu,
    #team_menu_overlay {
        background: #var(--nord00) !important;
    ...
    #convo_tab textarea#msg_text {
        width: 100%;
        background: var(--nord00) !important;
        border: 1px solid var(--nord00) !important;
        color: white !important;
    }
    ...
    #primary_file_button:hover {
        border: 2px solid var(--nord14);opacity:0.6 !important;
        background: var(--nord14);opacity:0.6 !important;
    }
    #primary_file_button {
        position: absolute;
        bottom: 1.375rem;
    ...
    .channel_header { background: var(--nord00); box-shadow: inset 1px 0 0 0 var(--nord00); }
    ...
    #msg_input {
        background: var(--nord01) !important;
        border: none !important;
    }
    .p-file_list__empty {
        color: white !important;
    ...
    .c-message_list__day_divider__line {
        border-top: 1px dashed var(nord03);
        top: 13px;
    }
...
```
I make no promises but just love nord. It is a work in progress!
